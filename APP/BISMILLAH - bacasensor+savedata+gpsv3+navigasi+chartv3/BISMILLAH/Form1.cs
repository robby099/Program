        ...
        private void DataSensor()
        {
            try
            {
                ...
                if (dataTerima[0] == 'I')
                {
                    ...
                    this.chartTemp.Series["Data Suhu"].Points.AddY(dataSuhu);
                    this.chartWTS.Series["Data WTS"].Points.AddY(dataKekeruhanAir);
                    this.chartPH.Series["Data PH"].Points.AddY(dataPHAir);
                    this.chartDO.Series["Data DO"].Points.AddY(dataDO);
                }
            }
            catch (Exception ex)
            {
